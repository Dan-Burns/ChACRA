...
def process_trajectories(folder, 
    ...
    out_index : int or None
        ...
        1 corresponds to "protein" by default. If you specify "1", selection should be "protein".
    ...
    # gromacs index 14 corresponds to whatever the desired outputs components are here (protein + ligand)
    # index 1 corresponds to "protein" by default
    for i in range(20):
        folder_name = f"tpr_{i:02d}"
        print(f"Processing folder: {folder_name}")
        process_trajectories(folder_name, index=14, align_structure='protein_nohoh.pdb')
