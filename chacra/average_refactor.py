...
#     coords = u.positions - u.center_of_mass()
#     cov = np.cov(coords.T)
...
def create_com_surrounding_points_universe(u: mda.Universe,
    ...
    return new_u
## Try instead to align the full complex along principal axes.
## then align chain B to chain A in the the principally aligned orientation 
## Then rotation from B to A in this second universe.
